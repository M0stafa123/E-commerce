const Card = () => {
  return (
    <div className="item1">
      <div className="w-[270px] relative h-[200px] bg-[#F5F5F5]">
        <span className="top-2 left-2 rounded-lg absolute px-2 py-1 bg-[#DB4444] text-white">
          -40%
        </span>
        <p className="absolute flex items-center justify-center top-1 right-2 w-10 h-10 bg-white rounded-full  hover:brightness-50">
          <svg
        ...
        <p className="absolute flex items-center justify-center top-12 right-2 w-10 h-10 bg-white rounded-full  hover:brightness-50">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="22"
            height="16"
